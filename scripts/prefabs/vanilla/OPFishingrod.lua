local assets=
{
    ...
    Asset("IMAGE", "images/inventoryimages/vanilla/opfishingrod.tex"),
}
...
local function fn(Sim)
    ...
    inst.components.inventoryitem.imagename = "opfishingrod"
    inst.components.inventoryitem.atlasname = "images/inventoryimages/vanilla/opfishingrod.xml"
...
return Prefab( "common/inventory/opfishingrod", fn, assets)
